const CACHE='tracelens-v4';
const ASSETS=['./','./index.html','./styles.css','./reports.css','./app.js','./reports-core.js','./reports-ui.js','./reports-export.js','./manifest.webmanifest','./assets/icon.svg'];
